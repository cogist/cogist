...
from cogist.application.commands.change_style_command import ChangeStyleCommand
...
__all__ = ["Command", "AddNodeCommand", "DeleteNodeCommand", "EditTextCommand", "CommandHistory", "ChangeStyleCommand"]

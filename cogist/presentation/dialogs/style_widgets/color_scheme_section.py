...
class ColorSchemeSection(CollapsiblePanel):
    ...
    def _init_content(self):
        ...
        border_label.setAlignment(Qt.AlignRight | Qt.AlignVCenter)
        ...
        layout.addWidget(border_label, 2, 0)
        ...
        conn_label = QLabel("Connector:")
        conn_label.setAlignment(Qt.AlignRight | Qt.AlignVCenter)
        ...
        canvas_label.setAlignment(Qt.AlignRight | Qt.AlignVCenter)
        ...
        self.canvas_row = 4
        layout.addWidget(canvas_label, 4, 0)
